...
// import {PaperTag,FancyDivider } from './PokemonDetailView.styles';
...
//   return (
//    <Box width={"100vw"} height={"100vh"} sx={{display:"flex", justifyContent:"center", alignItems:"center",backgroundColor:"#3D3539" }}>
...
import {pokemonContext} from "../../PokemonContextProvider/PokemonContextProvider"
import { useParams } from 'react-router-dom';
import {PaperTag,FancyDivider,movesDetail } from './PokemonDetailView.styles';
import {Chip} from '@mui/material';
import { ArrowDownward } from '@mui/icons-material';
const PokemonDetailView = () => {
const {id} = useParams();
const {pokemonImage,evolutionSpecies,abilities,stats,moves,movesInDetail,pokemonName,fetchPokemonById,handleDetailMoves} = useContext(pokemonContext);
  ...
  return (
   <Box  sx={{display:"flex",width:"100vw" ,height:"100vh", justifyContent:"center",alignItems:"center",background:"linear-gradient(to right top, #070411, #07101a, #05191f, #062021, #0e2620);" }}>
